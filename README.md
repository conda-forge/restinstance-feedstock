...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/restinstance-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10218&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/restinstance-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `restinstance` can be installed with:

```
conda install restinstance
```

It is possible to list all of the versions of `restinstance` available on your platform with:
